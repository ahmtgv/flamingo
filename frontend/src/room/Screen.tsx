  ...
  return (
    <div className={s.screen}>
      ...
      <div className={s.pult} data-pult="экран">
        ...
        {/* 🔴 ПОДСКАЗКА РАЗВЁРНУТА ПО РОЛИ, КАК И ПОДПИСЬ НАД НЕЙ. Раньше она
            стояла вне развилки, и ученик читал «показом управляете вы» —
            прямую неправду: у него нет ни указателя, ни кнопки. Осмотр
            комнаты 08.09, находка 14. */}
        <span className={s.hint}>
          {mine
            ? 'класс смотрит, но нажимать у себя не может — показом управляете вы'
            : `нажимать в чужом экране нельзя — окнами и указателем управляет ${who}`}
        </span>
        {mine ? (
