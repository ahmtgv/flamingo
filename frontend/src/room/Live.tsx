 ...
 *
 *  Что показываем в самой комнате: встраиваемое (видеохостинг, прямой файл,
 *  картинка) идёт прямо здесь; остальное честно даёт адрес — чужой сайт вправе
 *  запретить показ у себя внутри рамки, и притворяться, что это наша поломка,
 *  мы не будем.
 */
  ...
  return (
    <div className={s.live}>
      <div className={s.frameBox}>
        ...
        {e.kind === 'link' ? (
          /* ПРАВИЛА 6.4: причина названа, и дано одно действие. */
          <div className={s.card}>
            <span className={s.cardTitle}>Этот источник открывается у себя</span>
            <span className={s.cardText}>
              Чужой сайт вправе запретить показ внутри чужой рамки, и многие запрещают.
              Откройте его в новой вкладке и покажите классу экраном — или дайте ссылку
              ученикам, чтобы они смотрели у себя.
            </span>
            <a className={s.cardLink} href={e.src} target="_blank" rel="noreferrer">
              {e.src}
            </a>
          </div>
        ) : null}
