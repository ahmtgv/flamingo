/** ВНЕ ПРОДУКТА: полосу лиц не рисует ни один путь комнаты — сцена собрана
 *  из `Stage` и `Tiles`. Модуль оставлен, а не снят: снимать вещи — решение
 *  владельца (CLAUDE.md §3а). Ждёт ответа: нужен ли отдельный вид «лица
 *  полосой» рядом с плитками, или он заменён плитками насовсем.
 *  Стенд его показывает (экран «лица») — и показывает вид, до которого живой
 *  человек дойти не может. Об этом и пометка.
 */
