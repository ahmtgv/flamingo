...
function dashboard(over: Partial<TeacherDashboardQuery['teacherDashboard']>): TeacherDashboardQuery {
  return {
    ...
    teacherDashboard: {
      ...
      pendingSubmissions: [
        { __typename: 'Submission', id: 'p-1', submittedAt: iso(-2 * DAY - 3 * HOUR), status: 'LATE', student: { __typename: 'StudentProfile', user: { __typename: 'User', id: 'u-t', firstName: 'Тимур', lastName: 'И.' } }, homework: { __typename: 'Homework', id: 'h-1', title: 'Задачи 12–18', lesson: { __typename: 'Lesson', id: 'les-1', title: 'Линейные уравнения' } } },
        { __typename: 'Submission', id: 'p-2', submittedAt: iso(-4 * HOUR), status: 'SUBMITTED', student: { __typename: 'StudentProfile', user: { __typename: 'User', id: 'u-v', firstName: 'Вера', lastName: 'С.' } }, homework: { __typename: 'Homework', id: 'h-2', title: 'Графики', lesson: { __typename: 'Lesson', id: 'les-2', title: 'Функции' } } },
      ],
      ...over,
    },
  };
