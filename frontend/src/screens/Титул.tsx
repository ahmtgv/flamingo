          ...
          <div className={s.лента}>
            {РОЛИКИ.map((р) => (
              <div className={s.ролик} key={р.файл}>
                ...
                {/* 🔴 ПОДПИСЬ — РОВНО ДВЕ СТРОКИ (решение владельца 10.09). Метка
                    предмета вернулась на кадр: со своей подложкой контраст к
                    фотографии не зависит от неё вовсе (4,91 днём, 5,63 ночью), а
                    обрезка, из-за которой метку и уносили вниз, ушла вместе с
                    ростом обложки — в 76 px «математика» не влезала, в 99 стоит
                    целиком. Внизу остаётся имя, и ему отданы обе строки. */}
