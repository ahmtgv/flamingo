      ...
      <div className={s.разворот}>
        <div className={s.левая} ref={левая}>
          <div className={s.слова} ref={слова}>
            <span className={s.бровь}>Живой урок, а не запись</span>
            <h1 className={s.заголовок}>Наука, от которой не оторваться</h1>
            <p className={s.лид}>
              Одна ссылка — и класс в сборе: общая доска, документы во весь экран
              и ответ сразу, а не завтра в комментариях.
            </p>
            <span className={s.кому}>
              <b>ученику</b> ссылка · <b>преподавателю</b> журнал · <b>всем</b> источники мира
            </span>
          </div>
          ...
          <div className={`${s.проБлок} ${стопкой ? s.стопкой : s.сбоку}`} ref={блок}>
            ...
            <button type="button" className={s.промо} ref={промо} data-still="проморолик снимается">
              {постер()}
              <span className={s.проМетка}>проморолик</span>
            ...
            <span className={s.проТекст}>
              <span className={s.проПодпись} ref={подпись}>
                Как проходит урок за 45 минут<s>скоро</s>
              </span>
            </span>
          </div>
        </div>
