 ...
 * курса целиком.
 *
 * Остальные — инлайновые формы конструктора, сохранённые материалы, правка саммари — остаются
 * долгом. Ставить здесь ноль значило бы соврать; ставить «сколько получится» — ничего
 * не проверять. Поэтому число: оно может только уменьшаться.
 *
 * 17.08: 20 → **18**. Экран учреждения (настройки, оформление, одобрение и удаление участника)
 * перестал молчать — четыре вызова обёрнуты, отказ виден там же, где нажимали.
 *
