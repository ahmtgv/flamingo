      ...
      startPage: {
        ...
        teaching: [
          ...
          },
          {
            ...
            isDraft: false,
            nextAt: inMin(1500),
            nextLessonTitle: 'Системы уравнений',
          },
          {
            __typename: 'StartCourse',
            courseId: IDS.course.geometry,
    ...
    mySchedule: [
      {
        ...
        status: 'LIVE',
        courseId: IDS.course.algebra,
        courseTitle: 'Алгебра: от уравнений к функциям',
      ...
      },
      {
        ...
        status: 'SCHEDULED',
        courseId: IDS.course.english,
        courseTitle: 'Английский: разговорная практика',
      ...
      },
      {
        ...
        endAt: null,
        status: 'SCHEDULED',
        courseId: IDS.course.physics,
        courseTitle: 'Физика: решаем вторую часть',
