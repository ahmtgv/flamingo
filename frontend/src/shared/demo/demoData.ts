 ...
 * atlas (docs/design-previews/atlas/). 🔴 Имена нейтральные по решению владельца 14.08:
 * Ученик 1…8 · Преподаватель · Родитель · Администратор · Группа А · Учебное заведение.
 * Выдуманные люди с адресами почты выглядели как настоящие пользователи продукта — на витрине
 * это не демонстрация, а вымысел, который кто-нибудь однажды примет за данные.
