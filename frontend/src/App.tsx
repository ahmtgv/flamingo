...
export function App() {
  ...
  if (!code) {
    ...
    return person
      ? кабинет(person)
      : <Титул onSign={() => go('/вход')} onHub={() => go('/hub')} молчит={молчит} onAgain={спроситьСнова} />
  }
