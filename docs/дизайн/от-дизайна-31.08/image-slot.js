  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap">Снимку нужна подпись автора</div></div>' +
        ...
        '<div class="ctl" popover="manual" data-dc-edit-transparent><button data-act="replace" title="Заменить снимок">Заменить</button>' +
        '  <button data-act="edit" title="Передвинуть снимок в рамке">Кадрировать</button></div>' +
