...
# 🔴 БОЛЬШОЙ КВАДРАТ БЕРЁМ. Это не придирка к формату: на боевом обходе 12.09
# правило «квадрат = логотип» выбросило снимок «Хаббла» 1120×1120 — настоящую
# фотографию, которую NASA отдаёт квадратной. Проверка сторожит, чтобы правило
# не вернулось.
и_к = снимки.обновить_один(ПАПКА, "квадрат", f"{БАЗА}/kvadrat")
проверить("большой квадрат берём — это фотография, а не логотип", и_к.вышло, и_к.словами)
